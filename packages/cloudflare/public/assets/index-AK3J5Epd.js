...
` +
    ...
    var A = Math.clz32 ? Math.clz32 : Je,
      Ke = Math.log,
      qe = Math.LN2;
    function Je(e) {
...
`
  ...
  S = /###/g,
  C = (e) => (e && e.indexOf(`###`) > -1 ? e.replace(S, `.`) : e),
  w = (e) => !e || v(e),
  ee = (e, t, n) => {
    let r = v(t) ? t.split(`.`) : t,
      i = 0;
    ...
    return w(e) ? {} : { obj: e, k: C(r[i]) };
  },
  te = (e, t, n) => {
    let { obj: r, k: i } = ee(e, t, Object);
  ...
  ne = (e, t, n, r) => {
    let { obj: i, k: a } = ee(e, t, Object);
    ((i[a] = i[a] || []), i[a].push(n));
  },
  T = (e, t) => {
    let { obj: n, k: r } = ee(e, t);
  ...
  D = (e, t, n) => {
    ((t ||= ``), (n ||= ``));
    let r = le.filter((e) => t.indexOf(e) < 0 && n.indexOf(e) < 0);
    if (r.length === 0) return !0;
    let i = E.getRegExp(`(${r.map((e) => (e === `?` ? `\\?` : e)).join(`|`)})`),
      a = !i.test(e);
    if (!a) {
      let t = e.indexOf(n);
  ...
  k = class extends O {
    ...
    getResource(e, t, n, r = {}) {
      ...
      return (
        ...
        s || !a || !v(n) ? s : ue(this.data?.[e]?.[t], n, i)
      );
    }
...
function ge() {
  ...
  return (
    (t.get = (r, i) => (
      n?.revoke?.(),
      i === he ? e : (e.push(i), (n = Proxy.revocable(r, t)), n.proxy)
    )),
...
var ve = {},
  ye = (e) => !v(e) && typeof e != `boolean` && typeof e != `number`,
  be = class e extends O {
    constructor(e, t = {}) {
      (super(),
        x(
          [
    ...
    extractFromKey(e, t) {
      ...
      if (a && !o) {
        ...
        if (t && t.length > 0) return { key: e, namespaces: v(i) ? [i] : i };
        let a = e.split(n);
    ...
    translate(t, n, r) {
      ...
      if (
        ...
        return ``;
      (typeof t == `function` && (t = _e(t, { ...this.options, ...i })),
      ...
      b && !m && S && (ne = te);
      let T = ye(ne),
        re = Object.prototype.toString.apply(ne);
      if (b && ne && T && _.indexOf(re) < 0 && !(v(y) && Array.isArray(ne))) {
        if (!i.returnObjects && !this.options.returnObjects) {
          ...
          let e = this.options.returnedObjectHandler
            ? this.options.returnedObjectHandler(h, ne, { ...i, ns: c })
        ...
        if (o) {
          let e = Array.isArray(ne),
            t = e ? [] : {},
            n = e ? g : h;
          for (let e in ne)
            if (Object.prototype.hasOwnProperty.call(ne, e)) {
              let r = `${n}${o}${e}`;
              (S && !m
                ? (t[e] = this.translate(r, {
                    ...i,
                    defaultValue: ye(te) ? te[e] : void 0,
                    joinArrays: !1,
                    ns: c,
                  }))
      ...
      } else if (b && v(y) && Array.isArray(m))
        ((m = m.join(y)), (m &&= this.extendTranslation(m, t, i, r)));
      else {
        let e = !1,
          n = !1;
        (!this.isValidLookup(m) && S && ((e = !0), (m = te)),
        ...
        let a =
            ...
            n
              ? void 0
              : m,
          c = S && te !== m && this.options.updateMissing;
        if (n || e || c) {
          if (
            (this.logger.log(
    ...
    resolve(e, t = {}) {
      ...
      return (
        ...
        e.forEach((e) => {
          ...
          let u = t.count !== void 0 && !v(t.count),
  ...
  Te = (e, t, n, r = `.`, i = !0) => {
    let a = re(e, t, n);
    return (
      !a && i && v(n) && ((a = ue(e, n, r)), a === void 0 && (a = ue(t, n, r))),
      a
    );
  },
  Ee = (e) => e.replace(/\$/g, `$$$$`),
  De = class {
    ...
    nest(e, t, n = {}) {
      ...
      for (; (r = this.nestingRegexp.exec(e)); ) {
        let s = [];
        ((a = { ...n }),
          (a = a.replace && !v(a.replace) ? a.replace : a),
  ...
  ke = (e) => {
    ...
    return (n, r, i) => {
      ...
      let o = r + JSON.stringify(a),
        s = t[o];
      return (s || ((s = e(de(r), i)), (t[o] = s)), s(n));
    };
  },
  Ae = (e) => (t, n, r) => e(de(n), r)(t),
  je = class {
    constructor(e = {}) {
  ...
  Re = class e extends O {
    ...
    init(e = {}, t) {
      ...
      if (!this.options.isClone) {
        this.modules.logger
          ? pe.init(r(this.modules.logger), this.options)
        ...
        ((i.logger = pe),
          ...
          (i.interpolator = new De(this.options)),
          (i.utils = {
            hasLoadedNamespace: this.hasLoadedNamespace.bind(this),
          }),
          (i.backendConnector = new Ne(
        ...
        return (
          a.keyPrefix && Array.isArray(e)
            ? (s = e.map(
                (e) => (
                  typeof e == `function` &&
                    (e = _e(e, { ...this.options, ...t })),
                  `${a.keyPrefix}${o}${e}`
                )
              ))
            : (typeof e == `function` && (e = _e(e, { ...this.options, ...t })),
              (s = a.keyPrefix ? `${a.keyPrefix}${o}${e}` : e)),
          this.t(s, a)
        );
      };
      return (
        v(e) ? (r.lng = e) : (r.lngs = e),
        (r.ns = t),
        (r.keyPrefix = n),
        r
      );
...
var Be = {};
const Ve = (e, t, n, r) => {
  (A(n) && Be[n]) || (A(n) && (Be[n] = new Date()), ze(e, t, n, r));
};
var He = (e, t) => () => {
...
const Ue = (e, t, n) => {
  ...
  Ge = (e, t, n = {}) =>
    !t.languages || !t.languages.length
      ? (Ve(t, `NO_LANGUAGES`, `i18n.languages were undefined or empty`, {
...
const et = (e) => {
  ...
  nt = {
    type: `3rdParty`,
    init(e) {
      (Ze(e.options.react), et(e));
    },
  },
  rt = (0, _.createContext)();
var it = class {
    constructor() {
      this.usedNamespaces = {};
    }
...
const lt = (e, t = {}) => {
  let { i18n: n } = t,
    { i18n: r, defaultNS: i } = (0, _.useContext)(rt) || {},
    a = n || r || tt();
  (a && !a.reportNamespaces && (a.reportNamespaces = new it()),
    a ||
      Ve(
        a,
        `NO_I18NEXT_INSTANCE`,
  ...
  let f = (0, _.useRef)(0),
    ...
    [g, v] = (0, _.useState)(0),
    { t: y, ready: b } = (0, ot.useSyncExternalStore)(p, h, h);
  (0, _.useEffect)(() => {
    if (a && !b && !s) {
      let e = () => v((e) => e + 1);
      t.lng ? We(a, t.lng, d, e) : Ue(a, d, e);
    }
  }, [a, t.lng, d, b, s, g]);
  let x = a || {},
    S = (0, _.useRef)(null),
    ...
    ee = (0, _.useMemo)(() => {
      ...
      let r = [y, n, b];
      return ((r.t = y), (r.i18n = n), (r.ready = b), r);
    }, [y, x, b, x.resolvedLanguage, x.language, x.languages]);
  if (a && s && !b)
    throw new Promise((e) => {
      let n = () => e();
      t.lng ? We(a, t.lng, d, n) : Ue(a, d, n);
    });
  return ee;
};
var ut = o((e) => {
      ...
      children: (0, j.jsxs)(`div`, {
        ...
        children: [
          (0, j.jsxs)(`div`, {
            ...
            children: [
                ...
                children: [
                  (0, j.jsxs)(`svg`, {
                    ...
                    children: [
                      ...
                      (0, j.jsx)(`path`, { d: `M12 16v-4M12 8h.01` }),
                    ],
                  }),
                  `About Us`,
                ],
              ...
              (0, j.jsx)(`p`, {
                ...
                children: `SQL Pro was born to bridge the gap between complex database operations and simple, confident workflows. We're a team of developers who understand the frustration of juggling multiple database clients.`,
              }),
              (0, j.jsxs)(`div`, {
                  ...
                  (0, j.jsxs)(`div`, {
                    ...
                    children: [
                      (0, j.jsxs)(`span`, {
                        ...
                        children: [`325`, (0, j.jsx)(`sup`, { children: `+` })],
                      }),
                      (0, j.jsx)(`span`, {
                        className: `about-stat-label`,
                        children: `Trusted Users`,
                      }),
                    ],
                  }),
                  (0, j.jsxs)(`div`, {
                    ...
                    children: [
                      (0, j.jsxs)(`span`, {
                        className: `about-stat-value`,
                        children: [`125`, (0, j.jsx)(`sup`, { children: `+` })],
                      }),
                      (0, j.jsx)(`span`, {
                        className: `about-stat-label`,
                  ...
                  (0, j.jsxs)(`div`, {
                    ...
                    children: [
                      (0, j.jsx)(`h3`, {
                        ...
                        children: `Full Confidence`,
                      }),
                      (0, j.jsx)(`p`, {
                        className: `about-card-description`,
                        children: `Comprehensive AI guidance, expert-level insights and complete query monitoring.`,
                      }),
                    ],
                  }),
                ],
                  ...
                  (0, j.jsx)(`div`, {
                    ...
                    children: (0, j.jsxs)(`svg`, {
                      ...
                      children: [
                        ...
                        (0, j.jsx)(`circle`, { cx: `9`, cy: `7`, r: `4` }),
                        (0, j.jsx)(`path`, { d: `M23 21v-2a4 4 0 0 0-3-3.87` }),
                        (0, j.jsx)(`path`, { d: `M16 3.13a4 4 0 0 1 0 7.75` }),
                      ],
                    }),
                  }),
                  (0, j.jsxs)(`div`, {
                    ...
                    children: [
                      ...
                      (0, j.jsx)(`p`, {
                        className: `about-card-description`,
                        children: `Database management should focus on people and empathy, not just numbers.`,
                      }),
                    ],
                  }),
                ],
                  ...
                  (0, j.jsx)(`div`, {
                    ...
                    children: (0, j.jsxs)(`svg`, {
                      ...
                      children: [
                        ...
                        (0, j.jsx)(`polyline`, { points: `2 17 12 22 22 17` }),
                        (0, j.jsx)(`polyline`, { points: `2 12 12 17 22 12` }),
                      ],
                    }),
                  }),
                  (0, j.jsxs)(`div`, {
                    ...
                    children: [
                      ...
                      (0, j.jsx)(`p`, {
                        className: `about-card-description`,
                        children: `To offer steadfast assistance, remarkable accuracy, and a deep sense of calmness in your everyday routine.`,
                      }),
                    ],
                  }),
                ],
          ...
          (0, j.jsxs)(`div`, {
            ...
            children: [
              (0, j.jsx)(`div`, {
                className: `about-float-badge-icon`,
                children: (0, j.jsxs)(`svg`, {
                  viewBox: `0 0 24 24`,
                  fill: `none`,
                  stroke: `currentColor`,
              ...
              (0, j.jsxs)(`div`, {
                className: `about-float-badge-content`,
                children: [
                  (0, j.jsx)(`span`, {
                    className: `about-float-badge-title`,
                    children: `AI-Powered`,
                  }),
                  (0, j.jsx)(`span`, {
                    className: `about-float-badge-subtitle`,
                    children: `Smart assistance built-in`,
                  }),
                ],
              }),
            ],
...
var ft = ``,
  pt = () =>
    (0, j.jsx)(`svg`, {
      ...
      children: (0, j.jsx)(`path`, { d: `M19 12H5M12 19l-7-7 7-7` }),
    }),
  mt = () =>
    (0, j.jsxs)(`svg`, {
      width: `16`,
  ...
  gt = () =>
    (0, j.jsxs)(`svg`, {
      ...
      children: [
        ...
        (0, j.jsx)(`line`, { x1: `1`, y1: `10`, x2: `23`, y2: `10` }),
      ],
    }),
  _t = () =>
    (0, j.jsx)(`svg`, {
  ...
  vt = () =>
    (0, j.jsxs)(`svg`, {
      ...
      children: [
        ...
        (0, j.jsx)(`line`, { x1: `8`, y1: `21`, x2: `16`, y2: `21` }),
        (0, j.jsx)(`line`, { x1: `12`, y1: `17`, x2: `12`, y2: `21` }),
      ],
    }),
  yt = () =>
    (0, j.jsxs)(`svg`, {
      ...
      children: [
        ...
        (0, j.jsx)(`line`, { x1: `16`, y1: `2`, x2: `16`, y2: `6` }),
        (0, j.jsx)(`line`, { x1: `8`, y1: `2`, x2: `8`, y2: `6` }),
        (0, j.jsx)(`line`, { x1: `3`, y1: `10`, x2: `21`, y2: `10` }),
      ],
    }),
  bt = () =>
    (0, j.jsxs)(`svg`, {
      ...
      children: [
        ...
        (0, j.jsx)(`polyline`, { points: `15 3 21 3 21 9` }),
        (0, j.jsx)(`line`, { x1: `10`, y1: `14`, x2: `21`, y2: `3` }),
      ],
    });
function xt({ onClose: e }) {
  let { t } = lt(),
    [n, r] = (0, _.useState)({ authenticated: !1 }),
    [i, a] = (0, _.useState)(!0),
  ...
  async function u() {
    try {
      let t = await (
        await fetch(`${ft}/api/auth/me`, { credentials: `include` })
      ).json();
      (r(t), t.authenticated || e());
    } catch (t) {
      (console.error(`Auth check failed:`, t), e());
    } finally {
      a(!1);
    }
  }
  ...
  async function f() {
    ...
    try {
      let e = await (
        await fetch(`${ft}/api/billing/portal`, {
          method: `POST`,
          credentials: `include`,
        })
      ).json();
  ...
  function m(e) {
    return (
      ...
      }[e] || { label: e, className: `status-default` }
    );
  }
  function h(e) {
    return e
  ...
  if (i)
    return (0, j.jsx)(`div`, {
      ...
      children: (0, j.jsx)(`div`, {
        ...
        children: (0, j.jsx)(`div`, { className: `account-spinner` }),
      }),
    });
  let { user: v, licenses: y } = n,
    b = y?.some((e) => e.status === `active` || e.status === `trialing`),
    x = y?.some((e) => e.stripeSubscriptionId && e.plan !== `lifetime`);
  return (0, j.jsx)(`div`, {
    className: `account-page`,
    children: (0, j.jsxs)(`div`, {
          ...
          children: [
            (0, j.jsxs)(`button`, {
              ...
              children: [
                (0, j.jsx)(pt, {}),
                (0, j.jsx)(`span`, {
                  children: t(`account.backToHome`, `Back to Home`),
                }),
              ],
            }),
            (0, j.jsx)(`h1`, {
              className: `account-title`,
              children: t(`account.title`, `Account`),
            }),
          ],
        }),
        (0, j.jsxs)(`section`, {
          ...
          children: [
            (0, j.jsx)(`h2`, {
              ...
              children: t(`account.profile`, `Profile`),
            }),
            (0, j.jsx)(`div`, {
                    ...
                    children: [
                      ...
                      (0, j.jsxs)(`span`, {
                        ...
                        children: [
                          ...
                          ` `,
                          v?.provider === `github` ? `GitHub` : v?.provider,
                        ],
                      }),
                    ],
                  }),
        ...
        (0, j.jsxs)(`section`, {
          ...
          children: [
            ...
            y && y.length > 0
              ? (0, j.jsx)(`div`, {
                  ...
                  children: y.map((e) => {
                    ...
                    return (0, j.jsxs)(
                      `div`,
                      {
                        className: `license-card-full`,
                        children: [
                          (0, j.jsxs)(`div`, {
                            className: `license-card-header`,
                            children: [
                              (0, j.jsx)(`div`, {
                                className: `license-plan-badge`,
                                children: p(e.plan),
                              }),
                              (0, j.jsx)(`span`, {
                                className: `license-status-badge ${n.className}`,
                                children: n.label,
                              }),
                            ],
                          }),
                          (0, j.jsxs)(`div`, {
                            className: `license-key-section`,
                            children: [
                              (0, j.jsx)(`label`, {
                                className: `license-key-label`,
                                children: t(
                                  `account.licenseKey`,
                                  `License Key`
                                ),
                              ...
                              (0, j.jsxs)(`div`, {
                                className: `license-key-row`,
                                children: [
                                  (0, j.jsx)(`code`, {
                                    className: `license-key-code`,
                                    children: e.licenseKey,
                                  }),
                                  (0, j.jsxs)(`button`, {
                                    type: `button`,
                                    className: `copy-key-btn`,
                                    onClick: () => d(e.licenseKey),
                                    children: [
                                      o === e.licenseKey
                                        ? (0, j.jsx)(ht, {})
                                        : (0, j.jsx)(mt, {}),
                          ...
                          (0, j.jsxs)(`div`, {
                            className: `license-details-grid`,
                            children: [
                              (0, j.jsxs)(`div`, {
                                className: `license-detail`,
                                children: [
                                  (0, j.jsx)(vt, {}),
                                  (0, j.jsx)(`span`, {
                                    className: `license-detail-label`,
                                    children: t(`account.devices`, `Devices`),
                                  }),
                                  (0, j.jsxs)(`span`, {
                                    className: `license-detail-value`,
                                    children: [
                                      e.activeMachines || 0,
                                      ` / `,
                                      e.maxMachines,
                              ...
                              e.expiresAt &&
                                (0, j.jsxs)(`div`, {
                                  className: `license-detail ${i ? `expiring-soon` : ``}`,
                                  children: [
                                    (0, j.jsx)(yt, {}),
                                    (0, j.jsx)(`span`, {
                                      className: `license-detail-label`,
                              ...
                              e.plan === `lifetime` &&
                                (0, j.jsxs)(`div`, {
                                  ...
                                  children: [
                                    ...
                                    (0, j.jsx)(`span`, {
                                      className: `license-detail-value license-lifetime`,
                                      children: t(
              ...
              : (0, j.jsxs)(`div`, {
                  className: `no-licenses`,
                  children: [
                    (0, j.jsx)(`div`, {
                      className: `no-licenses-icon`,
                      children: (0, j.jsx)(_t, {}),
                    }),
                    (0, j.jsx)(`h3`, {
                      children: t(`account.noLicenses`, `No Active Licenses`),
                    }),
                    (0, j.jsx)(`p`, {
                      children: t(
                    ...
                    (0, j.jsx)(`button`, {
                      ...
                      children: t(`account.viewPlans`, `View Plans`),
                    }),
                  ],
                }),
          ],
        ...
        b &&
          (0, j.jsxs)(`section`, {
            ...
            children: [
              (0, j.jsx)(`h2`, {
                className: `account-section-title`,
                children: t(`account.quickActions`, `Quick Actions`),
              }),
              (0, j.jsxs)(`div`, {
                ...
                children: [
                  (0, j.jsxs)(`a`, {
                    ...
                    children: [
                      ...
                      (0, j.jsx)(`span`, {
                        children: t(`account.downloadApp`, `Download App`),
                      }),
                    ],
                  }),
                  (0, j.jsxs)(`a`, {
                    ...
                    children: [
                      ...
                      (0, j.jsx)(`span`, {
                        children: t(`account.documentation`, `Documentation`),
                      }),
                      (0, j.jsx)(bt, {}),
                    ],
                  }),
                  (0, j.jsxs)(`a`, {
                    ...
                    children: [
                      ...
                      (0, j.jsx)(`span`, {
                        children: t(`account.support`, `Get Support`),
                      }),
                    ],
                  }),
                ],
...
var St = () => {
  ...
  Ct = {
    ...
    unknown: (0, j.jsxs)(`svg`, {
      ...
      'aria-hidden': `true`,
      children: [
        (0, j.jsx)(`path`, { d: `M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4` }),
        (0, j.jsx)(`polyline`, { points: `7 10 12 15 17 10` }),
        (0, j.jsx)(`line`, { x1: `12`, y1: `15`, x2: `12`, y2: `3` }),
      ],
    }),
  };
function wt() {
  let { t: e } = lt(),
    [t, n] = (0, _.useState)(`unknown`);
  (0, _.useEffect)(() => {
    n(St());
  }, []);
  let r = e(`download.platforms.${t}`),
    i = e(`download.arch.${t}`),
    a = [`mac`, `windows`, `linux`].filter((e) => e !== t);
  return (0, j.jsx)(`section`, {
    className: `download`,
    id: `download`,
        ...
        children: [
          ...
          (0, j.jsxs)(`h2`, {
            ...
            children: [
              ...
              ` `,
              (0, j.jsx)(`span`, {
                className: `download-title-gradient`,
                children: e(`download.titleHighlight`),
              }),
            ],
          }),
          (0, j.jsx)(`p`, {
            className: `download-subtitle`,
            children: e(`download.subtitle`),
          }),
          (0, j.jsxs)(`a`, {
            ...
            children: [
              Ct[t],
              (0, j.jsxs)(`span`, {
                className: `download-main-text`,
                children: [
                  e(`download.downloadFor`, { platform: r }),
                  (0, j.jsx)(`small`, { id: `download-arch`, children: i }),
                ],
              }),
            ],
          }),
          (0, j.jsxs)(`nav`, {
            ...
            'aria-label': e(`download.otherPlatforms`),
            children: [
              (0, j.jsx)(`span`, {
                className: `download-other-label`,
                children: e(`download.otherPlatforms`),
              }),
              a.map((t) =>
                (0, j.jsxs)(
                  `a`,
                  {
                    ...
                    title: e(`download.arch.${t}`),
                    children: [Ct[t], e(`download.platforms.${t}`)],
                  },
                  t
                )
              ),
            ...
            children: [
              (0, j.jsxs)(`div`, {
                ...
                children: [
                  ...
                  (0, j.jsx)(`span`, { children: `Secure & Private` }),
                ],
              }),
              (0, j.jsxs)(`div`, {
                className: `download-feature`,
                children: [
                  (0, j.jsx)(`svg`, {
                    ...
                    strokeWidth: `2`,
                    'aria-hidden': `true`,
                    children: (0, j.jsx)(`polyline`, {
                      points: `20 6 9 17 4 12`,
                    }),
                  }),
                  (0, j.jsx)(`span`, { children: `Free Updates` }),
                ],
              }),
              (0, j.jsxs)(`div`, {
                className: `download-feature`,
                children: [
                  (0, j.jsxs)(`svg`, {
                    ...
                    children: [
                      (0, j.jsx)(`circle`, { cx: `12`, cy: `12`, r: `10` }),
                      (0, j.jsx)(`path`, { d: `M12 6v6l4 2` }),
                    ],
                  }),
                  (0, j.jsx)(`span`, { children: `24/7 Support` }),
                ],
              }),
            ],
          }),
...
var Tt = [
    {
      ...
      icon: `sparkles`,
      title: `AI Guidance`,
      description: `Get intelligent query suggestions and optimization tips powered by AI.`,
      variant: `default`,
      hasList: !0,
      listItems: [
        `Smart autocomplete`,
    ...
    },
    {
      ...
      description: `We make sure you're 100% safe while keeping things 100% clear without doubt.`,
      variant: `dark`,
      hasVisual: !0,
    },
    {
    ...
    },
    {
      ...
      description: `Connect to PostgreSQL, MySQL, SQLite, MongoDB and 120+ more database engines.`,
      variant: `accent`,
    },
    {
      key: `secure`,
  ...
  Et = {
    ...
    users: (0, j.jsxs)(`svg`, {
      ...
      'aria-hidden': `true`,
      children: [
        (0, j.jsx)(`path`, { d: `M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2` }),
        (0, j.jsx)(`circle`, { cx: `9`, cy: `7`, r: `4` }),
        (0, j.jsx)(`path`, { d: `M23 21v-2a4 4 0 0 0-3-3.87` }),
        (0, j.jsx)(`path`, { d: `M16 3.13a4 4 0 0 1 0 7.75` }),
      ],
    }),
    database: (0, j.jsxs)(`svg`, {
      viewBox: `0 0 24 24`,
      fill: `none`,
      stroke: `currentColor`,
      strokeWidth: `2`,
      'aria-hidden': `true`,
      children: [
        (0, j.jsx)(`ellipse`, { cx: `12`, cy: `5`, rx: `9`, ry: `3` }),
        (0, j.jsx)(`path`, { d: `M3 5V19A9 3 0 0 0 21 19V5` }),
        (0, j.jsx)(`path`, { d: `M3 12A9 3 0 0 0 21 12` }),
      ],
    }),
    lock: (0, j.jsxs)(`svg`, {
      viewBox: `0 0 24 24`,
      ...
      children: [
        ...
        (0, j.jsx)(`path`, { d: `M7 11V7a5 5 0 0 1 10 0v4` }),
      ],
    }),
  };
function Dt() {
  let { t: e } = lt(),
    [t, n] = (0, _.useState)(() => new Set()),
    r = (0, _.useRef)([]);
  return (
    (0, _.useEffect)(() => {
      let e = new IntersectionObserver(
        (e) => {
          e.forEach((e) => {
            ...
            e.isIntersecting && n((e) => new Set([...e, t]));
          });
        },
            ...
            children: [
              ...
              (0, j.jsxs)(`h2`, {
                ...
                children: [
                  ...
                  ` `,
                  (0, j.jsx)(`span`, {
                    className: `features-title-gradient`,
            ...
            children: Tt.map((e, n) =>
              (0, j.jsx)(
                `div`,
                {
                  ...
                  'data-index': n,
                  className: `feature-card-wrapper ${t.has(n) ? `visible` : ``}`,
                  style: { transitionDelay: `${n * 100}ms` },
                  children: (0, j.jsxs)(`div`, {
                    className: `feature-card ${e.variant}`,
                    role: `listitem`,
                    children: [
                      e.badge &&
                        (0, j.jsx)(`span`, {
                        ...
                        children: [
                            ...
                            (0, j.jsx)(`div`, {
                              ...
                              children: e.listItems.map((e, t) =>
                                (0, j.jsxs)(
                                  `div`,
                                  {
                                    className: `feature-card-list-item`,
                                    children: [
                                      (0, j.jsx)(`svg`, {
                                        viewBox: `0 0 24 24`,
                                        fill: `none`,
                          ...
                          e.hasVisual &&
                            (0, j.jsxs)(`div`, {
                              ...
                              children: [
                                (0, j.jsxs)(`div`, {
                                  className: `feature-card-visual-row`,
                                  children: [
                                    (0, j.jsx)(`span`, {
                                      className: `feature-card-visual-dot`,
                                    }),
                                    (0, j.jsx)(`span`, {
                                      className: `feature-card-visual-line long`,
                                    }),
                                  ],
                                }),
                                (0, j.jsxs)(`div`, {
                                  ...
                                  children: [
                                    ...
                                    (0, j.jsx)(`span`, {
                                      className: `feature-card-visual-line medium`,
                                    }),
                                  ],
                                }),
                                (0, j.jsxs)(`div`, {
                                  ...
                                  children: [
                                    ...
                                    (0, j.jsx)(`span`, {
                                      className: `feature-card-visual-line short`,
                                    }),
                                  ],
                                }),
                              ],
            ...
            (0, j.jsxs)(`div`, {
              ...
              children: [
                (0, j.jsx)(`h3`, {
                  ...
                  children: `Ready to transform your database workflow?`,
                }),
                (0, j.jsx)(`p`, {
                  className: `footer-cta-description`,
                  children: `Join thousands of developers using SQL Pro for smarter database management.`,
                }),
              ],
            }),
            (0, j.jsxs)(`a`, {
              ...
              children: [
                ...
                (0, j.jsxs)(`svg`, {
                  ...
                  children: [
                    ...
                    (0, j.jsx)(`polyline`, { points: `12 5 19 12 12 19` }),
                  ],
                }),
              ],
            }),
            ...
            (0, j.jsxs)(`div`, {
              ...
              children: [
                ...
                (0, j.jsx)(`p`, {
                  ...
                  children: `The modern database client for developers. Connect, query, and manage your databases with AI-powered intelligence.`,
                }),
                (0, j.jsxs)(`div`, {
        ...
        (0, j.jsxs)(`div`, {
          ...
          children: [
            (0, j.jsxs)(`p`, {
              ...
              children: [`© `, e, ` SQL Pro. All rights reserved.`],
            }),
            (0, j.jsxs)(`div`, {
              ...
              children: [
                ...
                (0, j.jsxs)(`div`, {
                  ...
                  children: [
                    (0, j.jsxs)(`span`, {
                      className: `hero-stat-value`,
                      children: [`18K`, (0, j.jsx)(`sup`, { children: `+` })],
                    }),
                    (0, j.jsx)(`span`, {
                      className: `hero-stat-label`,
        ...
        (0, j.jsxs)(`div`, {
          ...
          children: [
            ...
            (0, j.jsxs)(`div`, {
              ...
              role: `group`,
              'aria-label': e(`a11y.mainNavigation`),
              children: [
                (0, j.jsxs)(`a`, {
                  href: `#download`,
                ...
                (0, j.jsxs)(`a`, {
                  ...
                  'aria-label': e(`a11y.socialLink`, { name: `GitHub` }),
                  children: [
                    (0, j.jsx)(`svg`, {
                      viewBox: `0 0 24 24`,
                      fill: `currentColor`,
            ...
            (0, j.jsxs)(`div`, {
              ...
              children: [
                (0, j.jsxs)(`div`, {
                  ...
                  children: [
                    (0, j.jsx)(`div`, {
                      className: `hero-float-badge-icon`,
                      children: (0, j.jsx)(`svg`, {
                        viewBox: `0 0 24 24`,
                        fill: `none`,
                        stroke: `currentColor`,
                    ...
                    (0, j.jsxs)(`div`, {
                      className: `hero-float-badge-content`,
                      children: [
                        (0, j.jsx)(`span`, {
                          className: `hero-float-badge-value`,
                          children: `AI Confidence`,
                        }),
                        (0, j.jsx)(`span`, {
                          className: `hero-float-badge-label`,
                ...
                (0, j.jsxs)(`div`, {
                  ...
                  children: [
                    (0, j.jsxs)(`div`, {
                      ...
                      children: [
                        (0, j.jsxs)(`div`, {
                          className: `hero-preview-dots`,
                          children: [
                            (0, j.jsx)(`span`, {
                              className: `hero-preview-dot red`,
                            }),
                            (0, j.jsx)(`span`, {
                              className: `hero-preview-dot yellow`,
                            }),
                            (0, j.jsx)(`span`, {
                              className: `hero-preview-dot green`,
                            }),
                          ],
                        }),
                        (0, j.jsx)(`span`, {
                          className: `hero-preview-title`,
                          children: `SQL Pro — Database Manager`,
                        }),
                      ],
                    }),
                    (0, j.jsxs)(`div`, {
                      ...
                      children: [
                        (0, j.jsxs)(`div`, {
                          ...
                          children: [
                            (0, j.jsxs)(`div`, {
                              className: `hero-preview-sidebar-item active`,
                              children: [
                                (0, j.jsxs)(`svg`, {
                                  viewBox: `0 0 24 24`,
                                  fill: `none`,
                            ...
                            (0, j.jsxs)(`div`, {
                              className: `hero-preview-sidebar-item`,
                              children: [
                                (0, j.jsxs)(`svg`, {
                                  viewBox: `0 0 24 24`,
                                  fill: `none`,
                        ...
                        (0, j.jsxs)(`div`, {
                          className: `hero-preview-main`,
                          children: [
                            (0, j.jsxs)(`div`, {
                              className: `hero-preview-table-header`,
                              children: [
                                (0, j.jsx)(`span`, {
                                  className: `hero-preview-table-col`,
                                  children: `Column`,
                                }),
                                (0, j.jsx)(`span`, {
                                  className: `hero-preview-table-col`,
                            ...
                            (0, j.jsxs)(`div`, {
                              className: `hero-preview-table-row`,
                              children: [
                                (0, j.jsx)(`span`, {
                                  className: `hero-preview-table-cell code`,
                                  children: `id`,
                                }),
                                (0, j.jsx)(`span`, {
                                  className: `hero-preview-table-cell`,
                                  children: `SERIAL`,
                                }),
                                (0, j.jsx)(`span`, {
                                  className: `hero-preview-table-cell`,
                ...
                (0, j.jsxs)(`a`, {
                  ...
                  children: [
                    (0, j.jsxs)(`svg`, {
                      ...
                      'aria-hidden': `true`,
                      children: [
                        (0, j.jsx)(`polyline`, { points: `16 18 22 12 16 6` }),
                        (0, j.jsx)(`polyline`, { points: `8 6 2 12 8 18` }),
                      ],
                    }),
                    `SQL Editor`,
                  ],
                  ...
                  children: [
                    (0, j.jsxs)(`svg`, {
                      ...
                      children: [
                        ...
                        (0, j.jsx)(`polyline`, { points: `21 15 16 10 5 21` }),
                      ],
                    }),
                    `Data Visualization`,
                  ],
...
var Pt = ``;
function Ft({ isOpen: e, onClose: t }) {
  let { t: n } = lt(),
    [r, i] = (0, _.useState)(``),
    [a, o] = (0, _.useState)(!1),
  ...
  ((0, _.useEffect)(() => {
    let t = p.current;
    t && (e ? (t.showModal(), l || m.current?.focus()) : t.close());
  }, [e, l]),
    (0, _.useEffect)(() => {
      let t = (t) => {
        t.key === `Escape` && e && h();
  ...
  let h = (0, _.useCallback)(() => {
    ...
    v = async (e) => {
      if ((e.preventDefault(), r)) {
        ...
        try {
          let e = await (
            await fetch(`${Pt}/api/license/lookup`, {
              method: `POST`,
          ...
          e.success && e.license
            ? u(e.license)
            : c(e.error || n(`license.notFound`));
        } catch {
          c(n(`license.networkError`));
        } finally {
          o(!1);
        }
      }
    ...
    y = async () => {
      if (l)
        try {
          (await navigator.clipboard.writeText(l.licenseKey),
            f(!0),
            setTimeout(() => f(!1), 2e3));
        } catch {
          let e = document.createElement(`textarea`);
          ((e.value = l.licenseKey),
          ...
          children: [
            ...
            l
              ? (0, j.jsxs)(`div`, {
                  ...
                  children: [
                    (0, j.jsx)(`div`, {
                      className: `license-success-icon`,
                      children: (0, j.jsxs)(`svg`, {
                        width: `48`,
                        height: `48`,
                        viewBox: `0 0 24 24`,
                    ...
                    (0, j.jsx)(`h2`, {
                      ...
                      children: n(`license.successTitle`),
                    }),
                    (0, j.jsx)(`p`, {
                      className: `license-email`,
                      children: l.email,
                    }),
                    (0, j.jsxs)(`div`, {
                      ...
                      children: [
                        ...
                        (0, j.jsxs)(`div`, {
                          ...
                          children: [
                            (0, j.jsx)(`span`, {
                              className: `license-detail-label`,
                              children: n(`license.status`),
                            }),
                            (0, j.jsx)(`span`, {
                              className: `license-detail-value license-status-${l.status}`,
                              children: l.status,
                            }),
                          ],
                        }),
                        (0, j.jsxs)(`div`, {
                          ...
                          children: [
                            (0, j.jsx)(`span`, {
                              className: `license-detail-label`,
                              children: n(`license.devices`),
                            }),
                            (0, j.jsx)(`span`, {
                              className: `license-detail-value`,
                              children: l.maxMachines,
                            }),
                          ],
                        }),
                      ],
                    ...
                    (0, j.jsxs)(`div`, {
                      ...
                      children: [
                        (0, j.jsx)(`h3`, {
                          children: n(`license.howToActivate`),
                        }),
                        (0, j.jsxs)(`ol`, {
                          children: [
                            (0, j.jsx)(`li`, { children: n(`license.step1`) }),
                            (0, j.jsx)(`li`, { children: n(`license.step2`) }),
                            (0, j.jsx)(`li`, { children: n(`license.step3`) }),
                          ],
                        }),
                      ],
                    }),
              ...
              : (0, j.jsxs)(j.Fragment, {
                  children: [
                    (0, j.jsx)(`h2`, {
                      id: `license-title`,
                      className: `license-title`,
                      children: n(`license.lookupTitle`),
                    }),
                    (0, j.jsx)(`p`, {
                      className: `license-subtitle`,
                      children: n(`license.lookupSubtitle`),
                    }),
                    (0, j.jsxs)(`form`, {
                      onSubmit: v,
                      ...
                      children: [
                        ...
                        (0, j.jsx)(`input`, {
                          ...
                          placeholder: n(`license.emailPlaceholder`),
                          required: !0,
...
function Rt({ isOpen: e, plan: t, onClose: n }) {
  let { t: r } = lt(),
    [i, a] = (0, _.useState)(``),
    [o, s] = (0, _.useState)(!1),
  ...
  ((0, _.useEffect)(() => {
    let t = u.current;
    t && (e ? (t.showModal(), d.current?.focus()) : t.close());
  }, [e]),
    (0, _.useEffect)(() => {
      let t = (t) => {
        t.key === `Escape` && e && n();
    ...
    p = async (e) => {
      if ((e.preventDefault(), !(!t || !i))) {
        ...
        try {
          ...
          e.success && e.url
            ? (window.location.href = e.url)
            : l(e.error || r(`checkout.error`));
        } catch {
          l(r(`checkout.networkError`));
        } finally {
          s(!1);
        }
      }
        ...
        (0, j.jsxs)(`div`, {
          ...
          children: [
            (0, j.jsxs)(`div`, {
              ...
              children: [
                (0, j.jsxs)(`div`, {
                  className: `checkout-plan-info`,
                  children: [
                    (0, j.jsxs)(`span`, {
                      className: `checkout-plan-name`,
                      children: [r(`pricing.plans.${t}.title`), ` Plan`],
                    }),
                    (0, j.jsx)(`span`, {
                      className: `checkout-plan-description`,
                      children: r(`pricing.plans.${t}.description`),
                    }),
                  ],
                }),
                (0, j.jsxs)(`span`, {
                  className: `checkout-plan-price`,
                  children: [
                    r(`pricing.plans.${t}.price`),
                    (0, j.jsx)(`small`, {
                      children: r(`pricing.plans.${t}.period`),
                    }),
                  ],
                }),
              ],
        ...
        (0, j.jsxs)(`form`, {
          ...
          children: [
            (0, j.jsx)(`label`, {
              ...
              children: r(`checkout.emailLabel`),
            }),
            (0, j.jsx)(`input`, {
              ref: d,
              id: `checkout-email`,
              ...
              placeholder: r(`checkout.emailPlaceholder`),
              required: !0,
              className: `checkout-input`,
              disabled: o,
            }),
            (0, j.jsx)(`p`, {
              className: `checkout-email-hint`,
              children: r(`checkout.emailHint`),
            }),
            c &&
              (0, j.jsx)(`p`, {
  ...
  let { t: e } = lt(),
    t = (e) =>
      typeof e == `boolean`
        ...
        : (0, j.jsx)(`span`, { className: `feature-text`, children: e });
  return (0, j.jsxs)(`div`, {
    className: `comparison-table-wrapper`,
    children: [
      (0, j.jsx)(`h3`, {
        className: `comparison-title`,
        children: e(`pricing.comparison.title`),
      }),
      (0, j.jsx)(`div`, {
              ...
              children: (0, j.jsxs)(`tr`, {
                children: [
                  (0, j.jsx)(`th`, {
                    ...
                    children: e(`pricing.comparison.feature`),
                  }),
                  (0, j.jsxs)(`th`, {
                    ...
                    children: [
                      (0, j.jsx)(`span`, {
                        className: `plan-name`,
                        children: e(`pricing.plans.monthly.title`),
                      }),
                      (0, j.jsx)(`span`, {
                        className: `plan-price`,
                        children: e(`pricing.plans.monthly.price`),
                      }),
                    ],
                  }),
                  (0, j.jsxs)(`th`, {
                    className: `plan-header plan-header-featured`,
                    children: [
                      (0, j.jsx)(`span`, {
                        className: `featured-badge`,
                        children: e(`pricing.popular`),
                      }),
                      (0, j.jsx)(`span`, {
                        className: `plan-name`,
                        children: e(`pricing.plans.yearly.title`),
                      }),
                      (0, j.jsx)(`span`, {
                        className: `plan-price`,
                        children: e(`pricing.plans.yearly.price`),
                      }),
                    ],
                  }),
                  (0, j.jsxs)(`th`, {
                    ...
                    children: [
                      (0, j.jsx)(`span`, {
                        className: `plan-name`,
                        children: e(`pricing.plans.lifetime.title`),
                      }),
                      (0, j.jsx)(`span`, {
                        className: `plan-price`,
                        children: e(`pricing.plans.lifetime.price`),
                      }),
                    ],
                  }),
                ],
                  ...
                  `tr`,
                  {
                    children: [
                      (0, j.jsx)(`td`, {
                        ...
                        children: e(`pricing.comparison.features.${n.key}`),
                      }),
                      (0, j.jsx)(`td`, {
                        className: `feature-value`,
                        children: t(Bt.monthly[n.key]),
                      }),
                      (0, j.jsx)(`td`, {
                        className: `feature-value feature-value-featured`,
                        children: t(Bt.yearly[n.key]),
                      }),
                      (0, j.jsx)(`td`, {
                        className: `feature-value`,
                        children: t(Bt.lifetime[n.key]),
                      }),
                    ],
                  },
                  n.key
...
var Ht = [`monthly`, `yearly`, `lifetime`],
  Ut = {
    monthly: {
      icon: (0, j.jsxs)(`svg`, {
        viewBox: `0 0 24 24`,
    ...
    yearly: {
      icon: (0, j.jsxs)(`svg`, {
        ...
        children: [
          (0, j.jsx)(`circle`, { cx: `12`, cy: `12`, r: `10` }),
          (0, j.jsx)(`polyline`, { points: `12 6 12 12 16 14` }),
        ],
      }),
    },
    lifetime: {
...
function Wt() {
  ...
  return (0, j.jsxs)(`section`, {
    ...
    children: [
            ...
            children: [
              ...
              (0, j.jsxs)(`h2`, {
                ...
                children: [
                  ...
                  ` `,
                  (0, j.jsx)(`span`, {
                    className: `pricing-title-gradient`,
                    children: e(`pricing.titleHighlight`),
                  }),
                ],
              }),
              (0, j.jsx)(`p`, {
                className: `pricing-subtitle`,
                children: e(`pricing.subtitle`),
              }),
            ],
          }),
          (0, j.jsx)(`div`, {
            ...
            children: Ht.map((t) =>
              (0, j.jsxs)(
                `div`,
                {
                  className: `pricing-card ${t === `yearly` ? `featured` : ``}`,
                  role: `listitem`,
                  children: [
                    t === `yearly` &&
                      (0, j.jsx)(`div`, {
                    ...
                    (0, j.jsx)(`h3`, {
                      ...
                      children: e(`pricing.plans.${t}.title`),
                    }),
                    (0, j.jsxs)(`div`, {
                      ...
                      children: [
                        (0, j.jsx)(`span`, {
                          ...
                          children: e(`pricing.plans.${t}.price`),
                        }),
                        (0, j.jsx)(`span`, {
                          className: `pricing-period`,
                          children: e(`pricing.plans.${t}.period`),
                        }),
                      ],
                    }),
                    (0, j.jsx)(`p`, {
                      className: `pricing-description`,
                      children: e(`pricing.plans.${t}.description`),
                    }),
                    (0, j.jsx)(`ul`, {
                      className: `pricing-features`,
                      children: e(`pricing.plans.${t}.features`, {
                        returnObjects: !0,
                      }).map((e, t) =>
                        (0, j.jsxs)(
                          `li`,
                    ...
                    (0, j.jsx)(`button`, {
                      className: `pricing-cta ${t === `yearly` ? `pricing-cta-primary` : `pricing-cta-outline`}`,
                      onClick: () => a(t),
                      children: e(`pricing.cta`),
                    }),
                  ],
                },
                t
            ...
            children: [
              (0, j.jsxs)(`div`, {
                ...
                children: [
                  ...
                  (0, j.jsx)(`span`, { children: e(`pricing.trust.secure`) }),
                ],
              }),
              (0, j.jsxs)(`div`, {
                className: `trust-badge`,
                children: [
                  (0, j.jsxs)(`svg`, {
                    ...
                    'aria-hidden': `true`,
                    children: [
                      (0, j.jsx)(`path`, { d: `M3 3v18h18` }),
                      (0, j.jsx)(`path`, { d: `m19 9-5 5-4-4-3 3` }),
                    ],
                  }),
                  (0, j.jsx)(`span`, {
                    children: e(`pricing.trust.guarantee`),
                  }),
                ],
              }),
              (0, j.jsxs)(`div`, {
                ...
                children: [
                  ...
                  (0, j.jsx)(`span`, { children: e(`pricing.trust.stripe`) }),
                ],
              }),
            ],
          }),
      ...
      (0, j.jsx)(Rt, { isOpen: r, plan: t, onClose: o }),
    ],
  });
}
function Gt() {
...
var Kt = [
    ...
    {
      id: 2,
      quote: `The AI-powered suggestions save us hours every week. Highly recommend for any development team.`,
      author: `Michael Park`,
      role: `CTO, StartupXYZ`,
      initials: `MP`,
      featured: !1,
    ...
    {
      id: 3,
      quote: `Finally, a database tool that understands what developers actually need.`,
          ...
          (0, j.jsxs)(`div`, {
            ...
            children: [
              ...
              (0, j.jsx)(`p`, {
                ...
                children: `Join thousands of developers who trust SQL Pro for their database management needs.`,
              }),
              (0, j.jsx)(`div`, {
                ...
                children: qt.map((e) =>
                  (0, j.jsxs)(
                    `div`,
                    {
                      ...
                      children: [
                        (0, j.jsxs)(`span`, {
                          className: `testimonials-stat-value`,
                          children: [
                            e.value,
                            e.suffix &&
                              (0, j.jsx)(`sup`, { children: e.suffix }),
                          ],
                        }),
                        (0, j.jsx)(`span`, {
                          className: `testimonials-stat-label`,
                          children: e.label,
                        }),
                      ],
                    },
          ...
          (0, j.jsx)(`div`, {
            ...
            children: Kt.map((e) =>
              (0, j.jsxs)(
                `div`,
                {
                  className: `testimonial-card ${e.featured ? `featured` : ``}`,
                  children: [
                    (0, j.jsx)(`div`, {
                      className: `testimonial-rating`,
                      children: Array.from({ length: e.rating }).map((t, n) =>
                        (0, j.jsx)(
                          `svg`,
                          {
                            viewBox: `0 0 24 24`,
                        ...
                        e.highlight &&
                          (0, j.jsxs)(j.Fragment, {
                            children: [
                              ` `,
                              (0, j.jsx)(`span`, {
                                className: `testimonial-quote-highlight`,
...
var { slice: Yt, forEach: Xt } = [];
function Zt(e) {
  return (
    Xt.call(Yt.call(arguments, 1), (t) => {
...
var $t = /^[\u0009\u0020-\u007e\u0080-\u00ff]+$/,
  en = function (e, t) {
    ...
    if (n.domain) {
      if (!$t.test(n.domain)) throw TypeError(`option domain is invalid`);
      r += `; Domain=${n.domain}`;
    }
    if (n.path) {
      if (!$t.test(n.path)) throw TypeError(`option path is invalid`);
      r += `; Path=${n.path}`;
    }
    if (n.expires) {
  ...
  nn = {
    ...
    lookup(e) {
      ...
      if (t && typeof document < `u`) return tn.read(t) || void 0;
    },
    cacheUserLanguage(e, t) {
      ...
      n && typeof document < `u` && tn.create(n, e, r, i, a);
    },
  },
  rn = {
    name: `querystring`,
  ...
  sn = () => {
    ...
    try {
      if (((on = typeof window < `u` && window.localStorage !== null), !on))
        return !1;
  ...
  cn = {
    ...
    lookup(e) {
      ...
      if (t && sn()) return window.localStorage.getItem(t) || void 0;
    },
    cacheUserLanguage(e, t) {
      let { lookupLocalStorage: n } = t;
      n && sn() && window.localStorage.setItem(n, e);
    },
  },
  ln = null,
  un = () => {
    ...
    try {
      if (((ln = typeof window < `u` && window.sessionStorage !== null), !ln))
        return !1;
      let e = `i18next.translate.boo`;
  ...
  dn = {
    ...
    lookup(e) {
      ...
      if (t && un()) return window.sessionStorage.getItem(t) || void 0;
    },
    cacheUserLanguage(e, t) {
      let { lookupSessionStorage: n } = t;
      n && un() && window.sessionStorage.setItem(n, e);
    },
  },
  fn = {
    name: `navigator`,
...
var vn = () => ({
  ...
  yn = class {
    ...
    init() {
      ...
      ((this.services = e),
        (this.options = Zt(t, this.options || {}, vn())),
...
var bn = {
    meta: {
      title: `SQL Pro - Professional SQLite Database Manager`,
      description: `A modern, cross-platform SQLite database manager with encrypted database support, visual diff preview, and powerful query tools.`,
    },
    hero: {
      title: `SQL Pro`,
      subtitle: `Professional SQLite Database Manager`,
      description: `SQLCipher encryption support, visual diff preview, powerful query tools. Cross-platform, modern, and efficient.`,
    ...
    features: {
      ...
      subtitle: `SQL Pro provides a complete SQLite database management solution`,
      database: {
        title: `Database Management`,
        description: `SQLite and SQLCipher encrypted database support, secure password storage, multi-connection tabbed interface`,
      },
      query: {
        title: `Query Tools`,
        description: `Monaco editor with syntax highlighting, intelligent autocomplete, Vim mode, query history search`,
      },
      data: {
        title: `Data Operations`,
        description: `Inline table editing, diff preview before applying, bulk operations, advanced multi-column filtering`,
      },
      compare: {
        title: `Schema & Data Compare`,
        description: `Compare database schemas and table data between connections, generate migration scripts automatically`,
      },
      visualization: {
        title: `Visualization`,
        description: `ER diagram relationships, structure view browsing, automatic dark/light theme switching`,
      },
      security: {
        title: `Secure Encryption`,
        description: `SQLCipher support, seamless encrypted database integration, secure keychain storage`,
      },
      crossPlatform: {
        title: `Cross-Platform`,
        description: `Native support for macOS, Windows, Linux with unified experience and high performance`,
      },
    },
    screenshots: {
      title: `Interface Preview`,
      subtitle: `Modern design, professional experience`,
      welcome: `Elegant welcome interface`,
      database: `Powerful database browser`,
      table: `High-performance data table`,
      query: `Monaco SQL editor`,
      prev: `Previous`,
      next: `Next`,
    ...
    download: {
      ...
      subtitle: `Free download, cross-platform support`,
      downloadFor: `Download for {{platform}}`,
      otherPlatforms: `Other platforms:`,
      buildGuide: `Need to build from source? Check the`,
      buildGuideLink: `build guide`,
      platforms: {
        mac: `macOS`,
        windows: `Windows`,
        linux: `Linux`,
    ...
    footer: {
      ...
      copyright: `© {{year}} SQL Pro Team. Open source under MIT license.`,
      techStack: `Tech stack:`,
    },
    pricing: {
      title: `Simple,`,
      titleHighlight: `Transparent Pricing`,
      subtitle: `Choose the plan that works best for you. All plans include full access to all features.`,
      popular: `Most Popular`,
      cta: `Get Started`,
      note: `All plans include free updates. Cancel subscription anytime.`,
      trust: {
      ...
      comparison: {
        ...
        features: {
          ...
          schemaCompare: `Schema & Data Compare`,
      ...
      plans: {
        monthly: {
          ...
          price: `$9`,
          period: `/month`,
          description: `Perfect for trying out SQL Pro with full access to all features.`,
          features: [
            `All Pro features`,
        ...
        yearly: {
          ...
          price: `$69`,
          period: `/year`,
          description: `Best value for power users. Save over 35% compared to monthly.`,
          features: [
            `All Pro features`,
            `SQLCipher encryption support`,
            `Schema & data comparison`,
    ...
    checkout: {
      ...
      emailHint: `You can retrieve your license using this email after purchase`,
    ...
    license: {
      close: `Close`,
      lookupTitle: `Retrieve Your License`,
      lookupSubtitle: `Enter the email you used during purchase to retrieve your license key.`,
      successTitle: `Your License Key`,
      emailLabel: `Email Address`,
      emailPlaceholder: `you@example.com`,
      lookup: `Find My License`,
      searching: `Searching...`,
      notFound: `No license found for this email. Please check and try again.`,
      networkError: `Network error. Please check your connection.`,
      ...
      step1: `Open SQL Pro on your computer`,
      step2: `Go to Settings → License`,
      step3: `Enter your email and paste the license key`,
      done: `Done`,
    },
    a11y: {
      ...
      featureCard: `Feature: {{title}}`,
      socialLink: `Visit {{name}} (opens in new tab)`,
    },
  ...
  xn = {
    meta: {
      title: `SQL Pro - 专业的 SQLite 数据库管理工具`,
      description: `现代化、跨平台的 SQLite 数据库管理工具，支持加密数据库、可视化差异预览和强大的查询功能。`,
    },
    hero: {
      title: `SQL Pro`,
      subtitle: `专业的 SQLite 数据库管理工具`,
      description: `支持 SQLCipher 加密、可视化差异预览、强大的查询工具。跨平台、现代化、高效能。`,
      download: `立即下载`,
      github: `GitHub`,
      scrollHint: `向下滚动`,
    },
    features: {
      title: `强大功能，`,
      titleHighlight: `专业体验`,
      subtitle: `SQL Pro 提供完整的 SQLite 数据库管理解决方案`,
      database: {
        title: `数据库管理`,
        description: `支持 SQLite 和 SQLCipher 加密数据库，安全密码存储，多连接标签页界面`,
      },
      query: {
        title: `查询工具`,
        description: `Monaco 编辑器语法高亮，智能自动补全，Vim 模式，查询历史搜索`,
      },
      data: {
        title: `数据操作`,
        description: `表格内联编辑，应用前差异预览，批量操作，多列高级过滤`,
      },
      compare: {
        title: `结构与数据对比`,
        description: `对比不同连接间的数据库结构和表数据，自动生成迁移脚本`,
      },
      visualization: {
        title: `可视化`,
        description: `ER 图关系展示，结构视图浏览，深色/浅色主题自动切换`,
      },
      security: {
        title: `安全加密`,
        description: `SQLCipher 支持，加密数据库无缝集成，系统密钥链安全存储`,
      },
      crossPlatform: {
        title: `跨平台`,
        description: `macOS、Windows、Linux 原生支持，统一体验，高性能`,
      },
    },
    screenshots: {
      title: `界面预览`,
    ...
    footer: {
      ...
      issues: `问题反馈`,
      discussions: `讨论区`,
      copyright: `© {{year}} SQL Pro Team. 基于 MIT 协议开源。`,
      techStack: `技术栈：`,
    },
    pricing: {
      title: `简单，`,
      titleHighlight: `透明定价`,
      subtitle: `选择最适合您的方案。所有方案都包含全部功能。`,
      popular: `最受欢迎`,
      cta: `立即开始`,
      note: `所有方案包含免费更新。订阅可随时取消。`,
      trust: {
        secure: `安全支付`,
        guarantee: `30 天退款保证`,
      ...
      comparison: {
        ...
        features: {
          proFeatures: `所有专业功能`,
          sqlcipher: `SQLCipher 支持`,
          schemaCompare: `结构与数据对比`,
          aiFeatures: `AI 功能`,
          devices: `设备数量`,
          support: `技术支持`,
          updates: `更新服务`,
      ...
      plans: {
        monthly: {
          ...
          price: `$9`,
          period: `/月`,
          description: `完美试用 SQL Pro 的所有专业功能。`,
          features: [
            `所有专业功能`,
            `SQLCipher 加密支持`,
            `结构与数据对比`,
        ...
        yearly: {
          ...
          price: `$69`,
          period: `/年`,
          description: `资深用户最佳选择。比月付节省超过 35%。`,
          features: [
            `所有专业功能`,
            `SQLCipher 加密支持`,
            `结构与数据对比`,
        ...
        lifetime: {
          ...
          price: `$199`,
          period: `一次性付款`,
          description: `一次付款，永久使用。包含所有未来更新。`,
          features: [
            `永久享有所有专业功能`,
            `SQLCipher 加密支持`,
            `结构与数据对比`,
    ...
    license: {
      close: `关闭`,
      lookupTitle: `查询您的许可证`,
      lookupSubtitle: `输入购买时使用的邮箱来查询您的许可证密钥。`,
      successTitle: `您的许可证密钥`,
      emailLabel: `邮箱地址`,
      emailPlaceholder: `you@example.com`,
      lookup: `查询许可证`,
      searching: `查询中...`,
      notFound: `未找到此邮箱对应的许可证，请检查后重试。`,
      networkError: `网络错误，请检查您的网络连接。`,
      keyLabel: `您的许可证密钥`,
      copy: `复制到剪贴板`,
      plan: `订阅方案`,
      ...
      devices: `最大设备数`,
      howToActivate: `如何激活`,
      step1: `在您的电脑上打开 SQL Pro`,
      step2: `进入 设置 → 许可证`,
      step3: `输入您的邮箱并粘贴许可证密钥`,
      done: `完成`,
    },
    a11y: {
      ...
      themeSelector: `选择主题`,
      mainNavigation: `主导航`,
      featureCard: `功能：{{title}}`,
      socialLink: `访问 {{name}}（在新标签页打开）`,
    },
...
Re.use(yn)
  .use(nt)
  .init({
    resources: { en: { translation: bn }, zh: { translation: xn } },
    fallbackLng: `en`,
    supportedLngs: [`en`, `zh`],
    detection: {
...
function Cn() {
  let { i18n: e, t } = lt(),
    n = (t) => {
      e.changeLanguage(t.target.value);
    };
  return (0, j.jsxs)(`div`, {
    ...
    children: [
      (0, j.jsx)(`label`, {
        ...
        className: `sr-only`,
        children: t(`a11y.languageSelector`),
      }),
      (0, j.jsx)(`select`, {
        id: `language-select`,
        value: e.language.split(`-`)[0],
        onChange: n,
        ...
        children: Sn.map((e) =>
          (0, j.jsx)(
            `option`,
            { value: e.code, children: e.nativeName },
            e.code
          )
        ),
      }),
...
function Dn(e) {
  ...
  (t.classList.add(`theme-transition`),
    n === `dark` ? t.classList.add(`dark`) : t.classList.remove(`dark`),
...
function jn() {
  let e = (0, _.useSyncExternalStore)(On, kn, An),
    [t, n] = (0, _.useState)(() => (e === `system` ? Tn() : e));
  ((0, _.useEffect)(() => {
    (n(e === `system` ? Tn() : e), Dn(e));
  }, [e]),
    (0, _.useEffect)(() => {
      if (e !== `system`) return;
      let t = window.matchMedia(`(prefers-color-scheme: dark)`),
  ...
  let r = (0, _.useCallback)((e) => {
    try {
      (localStorage.setItem(wn, e),
        window.dispatchEvent(new StorageEvent(`storage`, { key: wn })));
    } catch {}
    Dn(e);
  }, []);
  return {
    ...
    icon: (0, j.jsx)(
      () =>
        (0, j.jsxs)(`svg`, {
          ...
          'aria-hidden': `true`,
          children: [
            (0, j.jsx)(`circle`, { cx: `12`, cy: `12`, r: `4` }),
            (0, j.jsx)(`path`, {
      ...
      () =>
        (0, j.jsxs)(`svg`, {
          ...
          children: [
            ...
            (0, j.jsx)(`line`, { x1: `8`, x2: `16`, y1: `21`, y2: `21` }),
            (0, j.jsx)(`line`, { x1: `12`, x2: `12`, y1: `17`, y2: `21` }),
          ],
        }),
      {}
    ),
...
function Nn() {
  let { t: e } = lt(),
    { theme: t, setTheme: n } = jn();
  return (0, j.jsx)(`div`, {
    className: `theme-switcher`,
    role: `radiogroup`,
    'aria-label': e(`a11y.themeSelector`, `Theme`),
    children: Mn.map((r) =>
      (0, j.jsx)(
        `button`,
        {
          ...
          'aria-label': e(r.labelKey, r.value),
          className: `theme-btn ${t === r.value ? `active` : ``}`,
          onClick: () => n(r.value),
          children: r.icon,
        },
        r.value
...
var Pn = ``,
  ...
  In = () =>
    (0, j.jsxs)(`svg`, {
      ...
      'aria-hidden': `true`,
      children: [
        (0, j.jsx)(`path`, { d: `M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2` }),
        (0, j.jsx)(`circle`, { cx: `12`, cy: `7`, r: `4` }),
      ],
    }),
  Ln = () =>
    (0, j.jsxs)(`svg`, {
...
function zn() {
  let { t: e } = lt(),
    [t, n] = (0, _.useState)({ authenticated: !1 }),
    [r, i] = (0, _.useState)(!0),
    [a, o] = (0, _.useState)(!1),
    s = (0, _.useRef)(null);
  ((0, _.useEffect)(() => {
    ...
    (0, _.useEffect)(() => {
      let e = new URLSearchParams(window.location.search),
        ...
        n = e.get(`error`);
      t === `success`
        ? (c(), window.history.replaceState({}, ``, window.location.pathname))
        : n &&
  ...
  async function c() {
    try {
      n(
        await (
          await fetch(`${Pn}/api/auth/me`, { credentials: `include` })
        ).json()
      );
    } catch (e) {
      (console.error(`Auth check failed:`, e), n({ authenticated: !1 }));
    } finally {
      i(!1);
    }
  }
  async function l() {
    try {
      (await fetch(`${Pn}/api/auth/logout`, {
        method: `POST`,
        credentials: `include`,
      }),
        n({ authenticated: !1 }),
  ...
  function u() {
    window.location.href = `${Pn}/api/auth/github`;
  }
  function d() {
    (o(!1), window.dispatchEvent(new CustomEvent(`openAccountPage`)));
  }
  function f() {
    let { licenses: n } = t;
    if (!n || n.length === 0) return null;
    let r = n.find((e) => e.status === `active` || e.status === `trialing`);
    return r
      ? r.plan === `lifetime`
        ? {
            label: e(`auth.lifetimePro`, `Lifetime Pro`),
            className: `status-lifetime`,
          }
        : r.status === `trialing`
          ? { label: e(`auth.trial`, `Trial`), className: `status-trial` }
          : { label: e(`auth.pro`, `Pro`), className: `status-active` }
      : { label: e(`auth.free`, `Free`), className: `status-free` };
  }
  if (r)
    return (0, j.jsx)(`div`, {
      className: `user-menu`,
      children: (0, j.jsx)(`div`, {
        ...
        'aria-label': e(`auth.loading`, `Loading...`),
        children: (0, j.jsx)(`div`, { className: `user-menu-spinner` }),
      }),
    });
  if (!t.authenticated)
    return (0, j.jsx)(`div`, {
      ...
      children: (0, j.jsxs)(`button`, {
        ...
        className: `login-btn`,
        onClick: u,
        'aria-label': e(`auth.loginWithGithub`, `Sign in with GitHub`),
        children: [
          (0, j.jsx)(Fn, {}),
          (0, j.jsx)(`span`, {
            className: `login-btn-text`,
            children: e(`auth.login`, `Sign in`),
          }),
        ],
      }),
    });
  ...
  return (0, j.jsxs)(`div`, {
    ...
    children: [
      (0, j.jsx)(`button`, {
        ...
        'aria-expanded': a,
        'aria-haspopup': `true`,
        'aria-label': e(`auth.accountMenu`, `Account menu`),
      ...
      a &&
        (0, j.jsxs)(`div`, {
          ...
          children: [
            (0, j.jsxs)(`div`, {
              ...
              children: [
                p?.avatarUrl
                  ...
                  : (0, j.jsx)(`div`, {
                      className: `user-avatar-placeholder-lg`,
                      children: (0, j.jsx)(In, {}),
                    }),
                (0, j.jsxs)(`div`, {
                  className: `user-info`,
                  children: [
                    ...
                    m &&
                      (0, j.jsx)(`span`, {
                        className: `user-subscription-badge ${m.className}`,
                        children: m.label,
                      }),
                  ],
                }),
            ...
            (0, j.jsx)(`div`, { className: `user-menu-divider` }),
            (0, j.jsxs)(`button`, {
              type: `button`,
            ...
            (0, j.jsxs)(`button`, {
              ...
              children: [
                (0, j.jsx)(Rn, {}),
                (0, j.jsx)(`span`, { children: e(`auth.logout`, `Sign out`) }),
              ],
            }),
          ],
        }),
...
function Bn() {
  return (0, j.jsxs)(`div`, {
    className: `top-bar`,
    children: [(0, j.jsx)(Nn, {}), (0, j.jsx)(Cn, {}), (0, j.jsx)(zn, {})],
  });
}
function Vn() {
  return (0, j.jsxs)(`div`, {
    ...
    children: [
      ...
      (0, j.jsx)(`span`, { className: `sr-only`, children: `Loading...` }),
    ],
  });
}
function Hn() {
  ...
  return (
    (0, _.useEffect)(() => {
      let e = new URLSearchParams(window.location.search),
        ...
        r = e.get(`page`);
      (t === `success` &&
        (n(!0), window.history.replaceState({}, ``, window.location.pathname)),
        r === `account` &&
          (i(!0),
          window.history.replaceState({}, ``, window.location.pathname)));
    }, []),
    (0, _.useEffect)(() => {
      ...
      return (
        window.addEventListener(`openAccountPage`, e),
        () => window.removeEventListener(`openAccountPage`, e)
      );
    }, []),
    r
      ? (0, j.jsx)(_.Suspense, {
          fallback: (0, j.jsx)(Vn, {}),
          children: (0, j.jsx)(xt, { onClose: () => i(!1) }),
        })
      : (0, j.jsxs)(_.Suspense, {
          fallback: (0, j.jsx)(Vn, {}),
          children: [
            ...
            (0, j.jsx)(Mt, {}),
            (0, j.jsx)(Ft, { isOpen: t, onClose: () => n(!1) }),
          ],
        })
  );
}
(0, g.createRoot)(document.getElementById(`root`)).render(
  (0, j.jsx)(_.StrictMode, { children: (0, j.jsx)(Hn, {}) })
);
