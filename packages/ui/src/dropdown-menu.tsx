      ...
      >
        <MenuPrimitive.Popup
          ...
          className={cn(
            ...
            'bg-popover/90 text-popover-foreground border-border z-50 max-h-(--available-height) w-(--anchor-width) min-w-36 origin-(--transform-origin) overflow-x-hidden overflow-y-auto rounded-lg border p-1 shadow-lg backdrop-blur-md duration-150 outline-none data-closed:overflow-hidden',
            className
          )}
          {...props}
        />
...
function DropdownMenuSubContent({
  ...
  return (
    <DropdownMenuContent
      ...
      className={cn(
        'data-open:animate-in data-closed:animate-out data-closed:fade-out-0 data-open:fade-in-0 data-closed:zoom-out-95 data-open:zoom-in-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2',
        'bg-popover/90 text-popover-foreground border-border w-auto min-w-28 rounded-lg border p-1 shadow-lg backdrop-blur-md duration-150',
        className
      )}
      align={align}
      alignOffset={alignOffset}
