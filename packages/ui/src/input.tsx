...
function Input({ className, type, ...props }: React.ComponentProps<'input'>) {
  return (
    <InputPrimitive
      ...
      data-slot="input"
      className={cn(
        'bg-background border-border placeholder:text-muted-foreground h-10 w-full min-w-0 rounded-[5px] border-2 px-3 py-2 [font-size:var(--font-ui-size,14px)] font-medium transition-all outline-none',
