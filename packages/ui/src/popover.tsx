      ...
      >
        <PopoverPrimitive.Popup
          ...
          className={cn(
            ...
            'border-border z-50 flex w-72 origin-(--transform-origin) flex-col gap-4 rounded-[5px] border-2 p-4 text-sm font-medium shadow-[4px_4px_0px_0px_var(--border)] outline-hidden duration-100',
            className
          )}
          {...props}
        />
