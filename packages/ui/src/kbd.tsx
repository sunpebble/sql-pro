  ...
  return (
    <kbd
      ...
      className={cn(
        ...
        // Size styles
        'data-[size=default]:h-5 data-[size=default]:min-w-5 data-[size=default]:rounded data-[size=default]:px-1 data-[size=default]:[font-size:calc(var(--font-ui-size,13px)*0.75)]',
        'data-[size=sm]:text-2xs data-[size=sm]:h-4 data-[size=sm]:min-w-4 data-[size=sm]:rounded-sm data-[size=sm]:px-0.5',
        className
      )}
      {...props}
    >
