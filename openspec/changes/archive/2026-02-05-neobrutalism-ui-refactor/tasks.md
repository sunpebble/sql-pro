...
- [x] 3.1 重构 TopBar 组件
- [x] 3.2 重构 Hero 组件
- [x] 3.3 重构 Features 组件
- [x] 3.4 重构 Screenshots 组件
- [x] 3.5 重构 Pricing 组件
- [x] 3.6 重构 Testimonials 组件
- [x] 3.7 重构 FAQ 组件
- [x] 3.8 重构 Download 组件
- [x] 3.9 重构 Footer 组件
- [x] 3.10 重构 Stats 组件
- [x] 3.11 移除所有自定义 CSS 类，使用 Tailwind 工具类

## 4. Electron App 核心组件

- [x] 4.1 重构 Sidebar 组件
- [x] 4.2 重构 ActivityBar 组件
- [x] 4.3 重构 DataTable 组件
- [x] 4.4 重构 Dialog 相关组件 (SettingsDialog, AboutDialog 等)
- [x] 4.5 重构 WelcomeScreen 组件
- [x] 4.6 重构 ConnectionSelector 组件

## 5. Electron App 功能组件

- [x] 5.1 重构 QueryView 组件
- [x] 5.2 重构 TableView 组件
- [x] 5.3 重构 ERDiagram 组件
- [x] 5.4 重构 MonacoSqlEditor 相关样式
- [x] 5.5 重构 ExportDialog 组件
- [x] 5.6 重构 BackupRestoreDialog 组件
- [x] 5.7 重构 SchemaComparison 相关组件
- [x] 5.8 重构 QueryBuilder 相关组件
...
- [x] 7.1 测试所有页面的视觉一致性
- [x] 7.2 测试所有组件的交互功能
- [x] 7.3 验证无障碍功能 (键盘导航、屏幕阅读器)
- [x] 7.4 验证响应式布局 (移动端、平板、桌面)
- [x] 7.5 运行 Lighthouse 性能测试
- [x] 7.6 删除未使用的自定义 CSS 文件
- [x] 7.7 更新 AGENTS.md 设计系统文档
