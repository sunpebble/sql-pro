...
- [ ] 设计系统升级为深色模式优先 + 橙色强调色
- [ ] App 导航结构简化，减少层级嵌套
- [ ] App 键盘快捷键体验强化 (Cmd+K 全局命令)
- [ ] App 微交互动效升级 (hover/transition/loading)
- [ ] 官网改版为极简风格落地页
- [ ] 官网移除冗余营销内容
- [ ] 官网加入产品演示/动效
...
| -------------- | ------------------------------------ | --------- |
| 深色模式优先   | 与 Linear/Raycast 风格一致，更显高端 | — Pending |
| 保留橙色强调色 | 品牌识别延续，在深色背景上更突出     | — Pending |
| 官网去营销化   | 小而美产品的调性，让产品说话         | — Pending |
