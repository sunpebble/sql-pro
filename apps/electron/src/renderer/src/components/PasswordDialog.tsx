          ...
          <form onSubmit={handleSubmit} className="mt-6 space-y-4">
            <div className="relative">
              ...
              <button
                ...
                className="text-muted-foreground hover:text-foreground absolute right-3 top-1/2 -translate-y-1/2 rounded-sm focus:outline-none focus-visible:ring-2 focus-visible:ring-main focus-visible:ring-offset-2"
                aria-label={
                  showPassword
