  ...
  return (
    ...
    >
      <div className="mx-auto max-w-[1280px] px-4 sm:px-5 md:px-12">
        ...
        <div className="mx-auto grid max-w-[1100px] grid-cols-1 gap-4 sm:grid-cols-2 sm:gap-6 lg:grid-cols-3">
...
function TestimonialCard({
  ...
  return (
    <div
      ref={ref}
      className={`group bg-card border-border rounded-xl border p-6 transition-all duration-300 ${
        isInView
    ...
    >
      ...
      <div className="border-border flex items-center gap-3 border-t pt-4">
        <img
          ...
          alt=""
          className="border-border group-hover:ring-main h-11 w-11 rounded-full border transition-all duration-300 group-hover:ring-2 group-hover:ring-offset-2"
          loading="lazy"
        />
